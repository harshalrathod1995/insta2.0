...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    //4. get download Url from fb strge and update to originial post
      ...
      >
        <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <Transition.Child
            ...
            leaveTo=" sm:scale-95 opacity-0 translate-y-4 sm:translate-y-0"
          >
            <div
              ...
              <div>
                ...
                <div className="sm-5 sm:mt-6">
                  <button
                    ...
                    focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-red-500 sm:text-sm
